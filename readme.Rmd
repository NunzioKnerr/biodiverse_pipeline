...
You may need an SVN and Git client
...
Biodiverse from here [Biodiverse Download page](https://code.google.com/p/biodiverse/wiki/Installation)\
...
It is in the "biodivesre_pipeline" folder"\
